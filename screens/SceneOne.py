...
class GameScene:
    def __init__(self, screen,sounds):
        ...
        self.state = "playing"
        self.timer = 0.0 
        self.player = CAINE(x=100,y=520)

        self.enemies = [
            Enemy1(x = 500, y = 520, patrol_left = 300, patrol_right = 700),
            Enemy2(x = 650, y = 520, patrol_left = 450, patrol_right = 780)
        ]
    ...
    def draw(self):
        ...
        self.screen.draw.line((0,530),(800,530),(80,50,20))
        for coin in self.coins: 
            coin.draw()
    ...
    def _draw_hud(self):
        ...
        for i in range(3): 
            ...
            try:
                self.screen.blit(img,(700+ i * 36, 10))
            except:
